...
<style>
    ...
    .fp-left {
        width: 50%; background: linear-gradient(135deg, #1a1a2e 0%, #2d2d44 100%);
    ...
    .fp-left .fp-steps li {
        ...
        font-size: 0.88rem; opacity: 0.75; border-bottom: 1px solid rgba(255,255,255,0.08);
    }
            ...
            <div class="fp-split">
                ...
                <div class="fp-right" id="fpRightPanel">
                    ...
                    <div class="fp-state" id="fp-step1">
                        ...
                        <div class="fp-back"><a href="login.php"><i class="bi bi-arrow-left me-1"></i> Back to Login</a></div>
                    </div>
                    ...
                    <div class="fp-state d-none" id="fp-step4">
                        <div class="verify-result">
                            ...
                            <button class="fp-btn-success" onclick="window.location.href='login.php'"><i class="bi bi-box-arrow-in-right me-2"></i>Go to Login</button>
                        </div>
                    </div>
