...
@section('nav_brands', 'active')
@section('brands_active', 'active')
    ...
    <div class="container brands-container">
        ...
        <div class="brand-filter-nav mb-5">
            ...
            <div class="brand-alphabet-nav" id="alphabetNav">
                ...
                <a href="#letter-C" class="brand-letter-link disabled" data-letter="C">C</a>
                ...
                <div class="col-lg-3 col-md-6" data-category="Fashion">
                    <div class="featured-brand-card" onclick="trackBrandView('Nike')">
                        ...
                        <div class="featured-brand-overlay">
                            ...
                            <a href="{{ url('/category/Mens?brand=Nike') }}" class="btn btn-purple-custom featured-brand-btn py-2 px-3">Explore Collection</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6" data-category="Fashion">
                    <div class="featured-brand-card" onclick="trackBrandView('Levi\'s')">
                        ...
                        <div class="featured-brand-overlay">
                            ...
                            <a href="{{ url('/category/Mens?brand=Levis') }}" class="btn btn-purple-custom featured-brand-btn py-2 px-3">Explore Collection</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6" data-category="Electronics">
                    <div class="featured-brand-card" onclick="trackBrandView('Intel')">
                        ...
                        <div class="featured-brand-overlay">
                            ...
                            <a href="{{ url('/category/Electronics?brand=Intel') }}" class="btn btn-purple-custom featured-brand-btn py-2 px-3">Explore Collection</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6" data-category="Beauty">
                    <div class="featured-brand-card" onclick="trackBrandView('L\'Oréal')">
                        ...
                        <div class="featured-brand-overlay">
                            ...
                            <a href="{{ url('/category/Women?brand=LOreal') }}" class="btn btn-purple-custom featured-brand-btn py-2 px-3">Explore Collection</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="all-brands-directory">
            ...
            <div class="brand-letter-section py-4" id="letter-A">
                ...
                <div class="brand-cards-grid">
                    ...
                    <a href="{{ url('/category/Mens?brand=Adidas') }}" class="brand-card-item" data-category="Fashion" onclick="trackBrandView('Adidas')">
                    ...
                    <a href="{{ url('/category/Electronics?brand=Apple') }}" class="brand-card-item" data-category="Electronics" onclick="trackBrandView('Apple')">
                    ...
                    <a href="{{ url('/category/HomeDecor?brand=Amazon') }}" class="brand-card-item" data-category="Home" onclick="trackBrandView('Amazon')">
                    ...
                    <a href="{{ url('/category/Mens?brand=Armani') }}" class="brand-card-item" data-category="Fashion" onclick="trackBrandView('Armani')">
                    ...
                    <a href="{{ url('/category/Electronics?brand=Asus') }}" class="brand-card-item" data-category="Electronics" onclick="trackBrandView('Asus')">
                    ...
                    <a href="{{ url('/category/Beauty?brand=Avon') }}" class="brand-card-item" data-category="Beauty" onclick="trackBrandView('Avon')">
            ...
            <div class="brand-letter-section py-4" id="letter-B">
                ...
                <div class="brand-cards-grid">
                    ...
                    <a href="{{ url('/category/HomeDecor?brand=Bosch') }}" class="brand-card-item" data-category="Home" onclick="trackBrandView('Bosch')">
                    ...
                    <a href="{{ url('/category/Electronics?brand=Bose') }}" class="brand-card-item" data-category="Electronics" onclick="trackBrandView('Bose')">
                    ...
                    <a href="{{ url('/category/Mens?brand=Burberry') }}" class="brand-card-item" data-category="Fashion" onclick="trackBrandView('Burberry')">
                    ...
                    <a href="{{ url('/category/Beauty?brand=Benefit') }}" class="brand-card-item" data-category="Beauty" onclick="trackBrandView('Benefit')">
                    ...
                    <a href="{{ url('/category/Mens?brand=Balenciaga') }}" class="brand-card-item" data-category="Fashion" onclick="trackBrandView('Balenciaga')">
                    ...
                    <a href="{{ url('/category/Mens?brand=Puma') }}" class="brand-card-item" data-category="Fashion" onclick="trackBrandView('Puma')">
            ...
            <div class="brand-letter-section py-4" id="letter-C">
                ...
                <div class="brand-cards-grid">
                    ...
                    <a href="{{ url('/category/Electronics?brand=Canon') }}" class="brand-card-item" data-category="Electronics" onclick="trackBrandView('Canon')">
                    ...
                    <a href="{{ url('/category/Bags?brand=Coach') }}" class="brand-card-item" data-category="Fashion" onclick="trackBrandView('Coach')">
                    ...
                    <a href="{{ url('/category/Accessories?brand=Casio') }}" class="brand-card-item" data-category="Electronics" onclick="trackBrandView('Casio')">
                    ...
                    <a href="{{ url('/category/Electronics?brand=Cisco') }}" class="brand-card-item" data-category="Electronics" onclick="trackBrandView('Cisco')">
